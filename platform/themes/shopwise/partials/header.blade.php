...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family={{ urlencode(theme_option('primary_font', 'Poppins')) }}:wght@200;300;400;500;600;700;800;900&display=swap" rel="stylesheet">
